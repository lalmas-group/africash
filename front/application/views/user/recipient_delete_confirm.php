	...
	<div class="row" style="margin: 10px;">
		<div class="col-md-offset-1 col-md-10">
			<?php if ( $status == "success" ) { ?>
				...
				<p style="text-color: green; margin: 10px;">Votre destinataire a bien été supprimé avec succès.</p>
			...
			<?php } else {?>
				...
				<p style="text-color: red/;">Votre destinataire n'a malheureusement pas été supprimé comme vous le souhaitez. Veuillez réessayer plus tard.</p>
